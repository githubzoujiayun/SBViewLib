 ...
 * @since 05.03.2013
 */
public class HoloCircularProgressBarCustom extends View {
	 ...
	 *            the context
	 */
	public HoloCircularProgressBarCustom(final Context context) {
		this(context, null);
	}
...
//				R.styleable.HoloCircularProgressBar_gravity, Gravity.CENTER);
		...
		mBackgroundColorPaint.setStrokeWidth(3); // (mCircleStrokeWidth);
													// //=======背景进度条的宽度
		...
		mMarkerColorPaint.setStrokeWidth(0); // (mCircleStrokeWidth / 2);
												// //===================

		mProgressColorPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
		mProgressColorPaint.setColor(mProgressColor);
		mProgressColorPaint.setStyle(Paint.Style.STROKE);
		mProgressColorPaint.setStrokeWidth(mCircleStrokeWidth); // =============前景进度条的宽度
		...
		mThumbColorPaint.setStrokeWidth(0);// (mCircleStrokeWidth);//===================
	...
	private void computeInsets(final int dx, final int dy) {
		...
		final int absoluteGravity = mGravity;
	...
	protected void onDraw(final Canvas canvas) {
		...
		canvas.drawArc(mCircleBounds, 270, mOverrdraw ? 0 : -progressRotation,
